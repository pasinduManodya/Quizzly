...
class MongoDBConnectionManager {
  ...
  async connect() {
    ...
    try {
      ...
      try {
        await dnsResolver.preResolveMongoDBHosts();
      } catch (error) {
      ...
      const mongoUri = process.env.MONGODB_URI || 'mongodb+srv://pasindu:12345@cluster0.yg0v7az.mongodb.net/test?retryWrites=true&w=majority&authSource=admin&directConnection=false&serverSelectionTimeoutMS=30000';
